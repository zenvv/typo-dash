...
function ChangeFont() {
    ...
    useEffect(() => {
        const font = getComputedStyle(document.documentElement).getPropertyPriority('--font-selected')
    }, []);
  ...
  return (
    <span className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-500/10">
      <label htmlFor="font-selector" className="text-lg"><PiTextAaFill /></label>
